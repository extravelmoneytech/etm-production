...
<?php
$title = "University Fee Payments from India Made Easy -ExTravelMoney";
$description = "Pay your tuition fee abroad from India at the best rates via your nearest bank or RBI authorized exchange house. Get your fee credited in 48 working hours!";
$fold = "../";
$ogurl = "https://www.extravelmoney.com/university-fee-payment/";
$ogtype = "article";
...
<body>
    <div class="flex flex-col items-center justify-center relative bg-white">
        ...
        <div class="w-full chooseCityOverlayMain  relative" style="max-width: 103rem;">
            ...
            <section class="mainSection  w-full flex justify-center items-center  relative">
                <div
                    ...
                    <div class="w-full md:w-6/12 md:pr-4 widgetContainer">
                        ...
                        <!--    savings-->
                        <!--</h1>-->
                        <h1 class="text-[1.9rem] md:text-headingCustom text-black font-bold tracking-tight">Univeristy
                            Fee Payments From India Made Easy!

                        </h1>
                        <p
                            class="text-opacity-60 sm:text-opacity-100 text-black mt-3 text-base sm:text-mediumFont sm:w-11/12">
                            SAVE UP TO 5% COMPARED TO YOUR BANK</p>
            ...
            <?php
            include $fold . 'includesv2/features_tutionFee.php';
            ?>
            ...
            <div class="cityPageContainer mt-12">

                <div class="flex  items-center gap-2 ">
                    <div class="w-2 h-12 bg-[#e31d1c]"></div>
                    <h2 class="text-[#040815] text-xl  customMd:text-[40px] font-bold  customMd:leading-[60px] ">How to Pay Tuition Fee Abroad from India?</h2>
                ...
                <div class="mt-8">
                    ...
                    <div class="university-container">
                        <div class="countries-grid">
                            ...
                            <div class="country-section">
                                ...
                                <ul class="university-list">
                                    <li class="university-item">
                                        ...
                                        <span class="university-name">Deakin University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Griffith University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Swinburne University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Macquarie University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                    ...
                                    <li class="university-item">
                                        ...
                                        <span class="university-name">University of Canberra</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">The University of Adelaide</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Western Sydney University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Flinders University</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="country-section">
                                ...
                                <ul class="university-list">
                                    <li class="university-item">
                                        ...
                                        <span class="university-name">Algonquin College</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">George Brown College</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University Canada West</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Seneca College</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Algoma University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Cape Bretom University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Concordia University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Fleming College</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Niagra College</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Northern College</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Sheridan College</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of British Columbia</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of Alberta</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of Calgary</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of Windsor</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">York University</span>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="country-section">
                                ...
                                <ul class="university-list">
                                    <li class="university-item">
                                        ...
                                        <span class="university-name">BPP University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of Hertfordshire</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Coventry University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Angila Ruskin University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of Bedfordshire</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">De Montfort University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">The University of Sheffield</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of Leicester</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of Essex</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of East London</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Sheffield Hallam University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of Sunderland</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Aston University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Queen Mary University London</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Nottingham Trent University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">London Metropolitan University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of Portsmouth</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">London South Bank University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Caucasus University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of Bradford</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of Nottingham</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of Salford</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                    ...
                                    <li class="university-item">
                                        ...
                                        <span class="university-name">University of West London</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">The University of Northampton</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Loughborough University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of Stirling</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Newcastle University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Heriot-Watt University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University Of Manchester</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of Liverpool</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of Central Lancashire</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">University of Westminster</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Cardiff Metropolitan University</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                    ...
                                    <li class="university-item">
                                        ...
                                        <span class="university-name">University for Creative Arts</span>
                                    </li>
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Birmingham City University</span>
                                    </li>
                            ...
                            <div class="country-section">
                                <h2 class="country-title">Ireland</h2>
                                <ul class="university-list">
                                    <li class="university-item">
                                        <svg class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                            stroke-width="2">
                                        ...
                                        <span class="university-name">Dublin Business School</span>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="cityPageContainer">
                ...
                <section>
                    ...
                    <!-- How to Pay Tuition Fee Abroad from India? -->
                        ...
                        <div>
                            <div class="flex  items-center gap-2 ">
                                ...
                                <h2
                                    ...
                                    How to Pay Tuition Fee Abroad from India?</h2>
                            </div>
                            ...
                            <div>
                                ...
                                <p
                                    class="text-black/60 mt-8 text-sm font-normal font-['Plus Jakarta Sans'] leading-[21px]">
                                    You can pay
                                    tuition fee abroad from India in 4 easy steps.</p>
                                <ul class="contentList mt-4">

                                    <li>Enter the country, amount, purpose of remittance and get rates from nearest
                                        banks & exchange houses</li>
                                    <li>Compare the rates, choose any and book your money transfer online. Submit your
                                        KYC documents for verification.</li>
                                    <li>Once the KYC is verified you can transfer the amount as NEFT/RTGS to chosen
                                        bank/exchange house's account.</li>
                                    <li>Your wire transfer will now be initiated. The beneficiary will recive the credit
                                        with in 2-3 working days.</li>
                                    ...
                                    <div class="grid md:grid-cols-3 justify-start gap-4  w-full ">
                                        <div class="flex justify-start">
                                            <a href="../university-fee-payment/india-to-usa/" target="_blank">
                                                <div class="location">
                                                    ...
                                                    <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div class="flex justify-start">
                                            <a href="../university-fee-payment/india-to-australia/" target="_blank">
                                                <div class="location">
                                                    <span class="flag-icon flag-icon-au mr-2"
                                                        style="width:1.8rem;"></span>
                                        ...
                                        <div class="flex justify-start">
                                            <a href="../university-fee-payment/india-to-canada/" target="_blank">
                                                <div class="location">
                                                    <span class="flag-icon flag-icon-ca mr-2"
                                                        style="width:1.8rem;"></span>
                                        ...
                                        <div class="flex justify-start">
                                            <a href="../university-fee-payment/india-to-uk/" target="_blank">
                                                <div class="location">
                                                    <span class="flag-icon flag-icon-gb mr-2"
                                                        style="width:1.8rem;"></span>
                                        ...
                                        <div class="flex justify-start">
                                            <a href="../university-fee-payment/india-to-new-zealand" target="_blank">
                                                <div class="location">
                                                    <span class="flag-icon flag-icon-nz mr-2"
                                                        style="width:1.8rem;"></span>
