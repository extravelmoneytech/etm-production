...
<?php
$title = "Pay German University Fee from India the Easy Way -ExTravelMoney";
            ...
            <section class="mainSection  w-full flex justify-center items-center  relative">
                <div
                    ...
                    <div class="w-full md:w-6/12 md:pr-4 widgetContainer">
                        ...
                        <!--    savings-->
                        <!--</h1>-->
                        <h1 class="text-[1.9rem] md:text-headingCustom text-black font-bold tracking-tight">Pay German
                        ...
                        <div>
                            <div class="flex  items-center gap-2 ">
                                ...
                                <h2
                                    ...
                                    How to Pay Your German University Fee from India?</h2>
                            </div>
                            <div>
                                <p
                                    class="text-black/60 mt-8 text-sm font-normal font-['Plus Jakarta Sans'] leading-[21px]">
                                    Here is how you can pay your German university fee from India.</p>
                                <ul class="contentList mt-4">
                                    <li> Enter the amount in EUR, choose the purpose as 'University/College Fee Payment'
                                        and get rates.</li>
                            ...
                            <div>
                                <h2
                                    ...
                                    Documents Required for Tuition Fee Payments to Germany</h2>
                                <ul class="contentList mt-4">
