...
<?php
$title = "Pay US University Fee from India the Easy Way -ExTravelMoney";
            ...
            <section class="mainSection  w-full flex justify-center items-center  relative">
                <div
                    ...
                    <div class="w-full md:w-6/12 md:pr-4 widgetContainer">
                        ...
                        <!--    savings-->
                        <!--</h1>-->
                        <h1 class="text-[1.9rem] md:text-headingCustom text-black font-bold tracking-tight">Pay Us University Fee From India The Easy Way
            ...
            <div class="cityPageContainer">
                        ...
                        <div>
                            <div class="flex  items-center gap-2 ">
                                ...
                                <h2
                                   ...
                                   How to Pay Your US University Fee from India</h2>
                            </div>
                            <div>
                                <p
                                    class="text-black/60 mt-8 text-sm font-normal font-['Plus Jakarta Sans'] leading-[21px]">
                                    Here is how you can pay your US university fee from India.</p>
                            ...
                            <div>
                                <h2
                                    ...
                                    Documents Required for Tuition Fee Payments to USA</h2>
                                <ul class="contentList mt-4">
                ...
                <div>
                    ...
                    * Flywire & Western Union payments are supported via our banking partners RBL Bank & Axis Bank.
                    ...
                    <b>Note:</b> Foreign Exchange and Money Transfer services are available though Tied-up Reserve Bank of India approved Authorized Dealers only. All foreign exchange transactions are subjected to AML/CFT/KYC & FEMA policies instructed by Reserve Bank of India.
                    </p>
                </div>
