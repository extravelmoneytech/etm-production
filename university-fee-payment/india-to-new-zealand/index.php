...
<?php
$title = "Pay New Zealand University Fee from India the Easy Way -ExTravelMoney";
$description = "Send your University/College tuition fee to the USA from India via an RBI authorized exchange house or bank and save up to 5%. Get credit within 2 working days.";
$fold = "../../";
$ogurl = "https://www.extravelmoney.com/university-fee-payment/india-to-usa/";
$ogtype = "article";
        ...
        <div class="w-full chooseCityOverlayMain  relative" style="max-width: 103rem;">
            ...
            <section class="mainSection  w-full flex justify-center items-center  relative">
                <div
                    ...
                    <div class="w-full md:w-6/12 md:pr-4 widgetContainer">
                        ...
                        <!--    savings-->
                        <!--</h1>-->
                        <h1 class="text-[1.9rem] md:text-headingCustom text-black font-bold tracking-tight">Pay New
                            Zealand
                            University Fee From India The Easy Way

                        </h1>
                        <p
                            class="text-opacity-60 sm:text-opacity-100 text-black mt-3 text-base sm:text-mediumFont sm:w-11/12">
                            Guaranted Savings On Every Transaction !</p>
            ...
            <div class="cityPageContainer">
                ...
                <section>
                    ...
                    <!-- How to Pay Your US University Fee from India -->
                        ...
                        <div>
                            <div class="flex  items-center gap-2 ">
                                ...
                                <h2
                                    ...
                                    How to Pay Your New Zealand University Fee from India?</h2>
                            </div>
                            <div>
                                <p
                                    class="text-black/60 mt-8 text-sm font-normal font-['Plus Jakarta Sans'] leading-[21px]">
                                    Here is how you can pay your New Zealand university fee from India.</p>
                                <ul class="contentList mt-4">
                                    <li> Enter the amount in AUD, choose the purpose as 'University/College Fee Payment'
                                        and get rates.</li>
                                    <li> Compare the exchange rates and choose a bank or RBI approved exchange house of
                                        your choice.</li>
                                    <li> You can now share the required KYC documents for verification. Once verified,
                                        transfer the amount to the processing bank as NEFT/RTGS.</li>
                                    <li> Wire transfer will now be initiated and the university will get the credit in
                                        the next 1-2 working days.</li>

                                </ul>
                            </div>
                            <div>
                                <h2
                                    class="text-black  text-base font-semibold font-['Plus Jakarta Sans'] leading-normal mt-12">
                                    Documents Required for Tuition Fee Payments to New Zealand</h2>
                                <ul class="contentList mt-4">
                                    <li>University Letter/Prospectus showing the fee amount</li>
                                    <li>Indian Passport Copy of the Student</li>
                                    <li>ID proof of the sender (Aadhar/Driving Licence/Voters ID/Passport)</li>
                                    <li>PAN Card of the sender</li>
                                    <p
                                        class="text-black/60 mt-2 text-sm font-normal font-['Plus Jakarta Sans'] leading-[21px]">
                                        The sender can be the student or his/her parents.</p>
                                </ul>
                            </div>
                            <div>
                                <h2
                                    class="text-black  text-base font-semibold font-['Plus Jakarta Sans'] leading-normal mt-12">
                                    University Account Details to be Shared:</h2>
                                <ul class="contentList mt-4">
                                    <li>University/College Account Number, Bank Name & Address.</li>
                                    <li>SWIFT Code & Transit Code.</li>
                                    <li>University/College Name & Address.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Make Tuition Fee Payments to (removed)-->
                ...
                <div>
                    <p class="text-black/60 text-mediumFont font-normal">
                        * Flywire & Western Union payments are supported via our banking partners RBL Bank & Axis Bank.
                    </p>
                    <p class="text-black/60 text-mediumFont font-normal mt-4">
                        <b>Note:</b> Foreign Exchange and Money Transfer services are available though Tied-up Reserve
                        Bank of India approved Authorized Dealers only. All foreign exchange transactions are subjected
                        to AML/CFT/KYC & FEMA policies instructed by Reserve Bank of India.
                    </p>
                </div>
