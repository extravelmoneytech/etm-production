            ...
            <section class="mainSection  w-full flex justify-center items-center  relative">
                <div
                    ...
                    <div class="w-full md:w-6/12 md:pr-4 widgetContainer">
                        ...
                        <p
                            class="text-opacity-60 sm:text-opacity-100 text-black mt-3 text-base sm:text-mediumFont sm:w-11/12">Transfer money from India to Canada easily at best CAD rates via RBI approved banks & exchange houses. Fast processing, great savings, zero hassle!</p>
