...
<?php
$title = "Send Money to Canada from India | Transfer money from India to Canada - ExTravelMoney";
$description = "Transfer money from India to Canada easily at best CAD rates via RBI approved banks & exchange houses. Fast processing, great savings, zero hassle!";
$ogurl = "https://www.extravelmoney.com/wire-transfer/india-to-canada/";
$ogtype = "article";
...
?>
<link rel="stylesheet" href="<?php echo $fold . 'stylesv2/countryPageStyles.css'; ?>">
...
<body>
    <div class="flex flex-col items-center justify-center relative bg-white">
        ...
        <div class="w-full chooseCityOverlayMain  relative" style="max-width: 103rem;">
            ...
            <section class="mainSection  w-full flex justify-center items-center  relative">
                <div
                    ...
                    <div class="w-full md:w-6/12 md:pr-4 widgetContainer">
                        ...
                        <!--</h1>-->
                        <h1 class="mainText">
                            Send Money to Canada from India
                        </h1>
                        <p class="paraText">Transfer money from India to Canada easily at best CAD rates via RBI
                            approved banks & exchange houses. Fast processing, great savings, zero hassle!</p>
            ...
            <?php
            include $fold . 'includesv2/features_mt.php';
            ?>
            ...
            <?php
            include $fold . 'includesv2/countries_mt.php';
            ?>
