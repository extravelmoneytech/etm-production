...
<?php
$title="Easy Money Transfer from India to Bahrain -ExTravelMoney"; 
$description="Sending money from India to Bahrain is now easy! Compare rates from your nearest RBI approved money changers & banks. Book online & get credit in 3 days."; 
$ogurl="https://www.extravelmoney.com/wire-transfer/india-to-bahrain/";
$ogtype="article";
...
<body>
    <div class="flex flex-col items-center justify-center relative bg-white">
                ...
                <div
                    ...
                    <div class="w-full md:w-6/12 md:pr-4 widgetContainer">
                        ...
                        <h1 class="text-[1.9rem] md:text-headingCustom text-black font-bold tracking-tight">
                            Send Money to Bahrain from India
                        </h1>
                        <p
                            class="text-opacity-60 sm:text-opacity-100 text-black mt-3 text-base sm:text-mediumFont sm:w-11/12">Send money from India to Bahrain easily at lowest exchange rates via RBI approved banks & exchange houses. Fast processing, great savings, zero hassle!</p>
        ...
        </div> <!-- Closing chooseCityOverlayMain div -->
    </div> <!-- Closing outer flex container div -->
</body>
