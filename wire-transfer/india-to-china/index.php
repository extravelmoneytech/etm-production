...
<?php
$title="India to China Money Transfer | Compare Rates & Book Online -ExTravelMoney"; 
$description="Send money to China from India the easy way! Get instant quotes from your nearest RBI authorized exchange houses & banks. Compare rates & book your money transfer online. Also avail door KYC pickup."; 

$ogurl="https://www.extravelmoney.com/wire-transfer/india-to-china/";
$ogtype="article";
            ...
            <section class="mainSection  w-full flex justify-center items-center  relative">
                <div
                    ...
                    <div class="w-full md:w-6/12 md:pr-4 widgetContainer">
                        ...
                        <p
                            class="text-opacity-60 sm:text-opacity-100 text-black mt-3 text-base sm:text-mediumFont sm:w-11/12">Send money from India to China easily at lowest exchange rates via RBI approved banks & exchange houses. Fast processing, great savings, zero hassle!</p>
