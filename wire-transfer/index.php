...
<?php
$title = "International Money Transfers from India Made Easy - ExTravelMoney";
$description = "Enjoy easy international money transfers from India. Compare real-time rates from trusted banks, and exchange houses & book transfers online to 100+ countries.";
$fold = "../";
$ogurl = "https://www.extravelmoney.com/wire-transfer/";
$ogtype = "article";
...
<body>
    <div class="flex flex-col items-center justify-center relative bg-white">
        ...
        <div class="w-full chooseCityOverlayMain  relative" style="max-width: 103rem;">
            ...
            <section class="mainSection  w-full flex justify-center items-center  relative">
                <div
                    ...
                    <div class="w-full md:w-6/12 md:pr-4 widgetContainer">
                        ...
                        <!--    savings-->
                        <!--</h1>-->
                        <h1 class="text-[1.9rem] md:text-headingCustom text-black font-bold tracking-tight">Send Money
                            Abroad from India
                        </h1>
                        <p
                            class="text-opacity-60 sm:text-opacity-100 text-black mt-3 text-base sm:text-mediumFont sm:w-11/12">
                            Send money from India to abroad easily at lowest exchange rates via RBI approved banks &
                            exchange houses. Fast processing, great savings, zero hassle!</p>
                            ...
                            <div class="flex gap-8">
                                <div class="flex flex-col gap-2">
                                    ...
                                    <p class="text-xl w-full font-bold"
                                        ...
                                        Save More</p>
                                    <span class="text-black/60 text-sm font-normal  leading-normal">5%+ better than
                                        <br />market rates.</span>
                                ...
                                <div class="flex flex-col gap-2">
                                    ...
                                    <p class="text-xl w-full font-bold"
                                        style="word-wrap: break-word;background: linear-gradient(329deg, #0E51A0 -43.1%, #E31D1C 144.49%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
                                        Fast Credit</p>
                                    <span class="text-black/60 text-sm font-normal  leading-normal">Credit/Delivery in
                    ...
                    <div class="hidden md:flex absolute right-0 top-6" style="width: 54%;max-height: 46rem;;">
                        <svg class="ml-8" width="100%" style="aspect-ratio: 1/1.25;opacity: 0.4;" viewBox="0 0 741 883"
            ...
            <?php
            include $fold . 'includesv2/howItWorksWireTransfer.php';
            ?>
            ...
            <div class="cityPageContainer">
                <div class="flex items-center gap-2">
                    ...
                    <h2 class="text-[#040815] text-xl customMd:text-[40px] font-bold  customMd:leading-[60px] ">Transfer
                        Money to 100+ Countries</h2>
                </div>
                <div class="locationContainer mt-8">
                    <div class=" grid grid-cols-1 md:grid-cols-3 gap-8 md:whitespace-nowrap">


                        <a href="../wire-transfer/india-to-usa/" target="_blank">
                            <div class="location space-x-2">
                                <span class="flag-icon flag-icon-us mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to USA</span>
                        ...
                        <a href="../wire-transfer/india-to-australia/" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-au mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Australia</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-canada/" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-ca mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Canada</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-uk/" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-gb mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to UK</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-europe" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-eu mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Europe</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-uae" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-ae mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to UAE</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-philippines" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-ph mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Philippines</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-malaysia" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-my mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Malaysia</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-germany" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-de mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Germany</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-singapore" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-sg mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Singapore</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-saudi-arabia/" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-sa mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Saudi Arabia</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-new-zealand" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-nz mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to New Zealand</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-france" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-fr mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to France</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-china" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-cn mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to China</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-netherlands" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-nl mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Netherlands</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-thailand" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-th mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Thailand</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-russia" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-ru mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Russia</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-sweden" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-se mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Sweden</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-indonesia" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-id mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Indonesia</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-poland" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-pl mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Poland</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-ireland" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-ie mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Ireland</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-qatar" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-qa mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Qatar</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-kuwait" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-kw mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Kuwait</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-bahrain" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-bh mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Bahrain</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-oman" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-om mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Oman</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-italy" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-it mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Italy</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-spain" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-es mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Spain</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-switzerland" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-ch mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Switzerland</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-austria" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-at mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Austria</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-latvia" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-lv mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Latvia</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-lithuania" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-lt mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Lithuania</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-finland" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-fi mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Finland</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-malta" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-mt mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Malta</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-denmark" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-dk mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Denmark</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-slovenia" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-si mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Slovenia</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-japan" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-jp mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Japan</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-south-korea" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-kr mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to South Korea</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                        ...
                        <a href="../wire-transfer/india-to-georgia" target="_blank">
                            <div class="location">
                                <span class="flag-icon flag-icon-ge mr-2" style="width:1.8rem;"></span>
                                <span class="locationName">Send Money to Georgia</span>
                                <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                    viewBox="0 0 24 24" fill="none">
                                    <path
                                        d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z"
                    ...
                    <div>
                        <div class="flex items-center gap-2">
                            ...
                            <h2 class="text-[#040815] text-xl customMd:text-[40px] font-bold  customMd:leading-[60px] ">
                                How to Transfer Money from India to Abroad?</h2>
                        </div>
                        <p class="text-black/60 mt-2 text-sm font-normal  leading-[21px]">To send money from India to
                            abroad, follow the four steps.</p>
                        ...
                        <ul class="contentList mt-4">
                            ...
                            <li>Enter the country, amount, purpose of remittance and get rates from nearest banks &
                                exchange houses</li>
                            <li>Compare the rates, choose any and book your money transfer online. Submit your KYC
                                documents for verification.</li>
                            <li>Once the KYC is verified you can transfer the amount as NEFT/RTGS to chosen
                                bank/exchange house's account.</li>
                            <li>Your wire transfer will now be initiated. The beneficiary will recive the credit with in
                                2-3 working days.</li>


                        </ul>

                        <h2 class="text-black  text-base font-semibold font-['Plus Jakarta Sans'] leading-normal mt-12">
                            Modes for Outward Remittance from India</h2>

                        <ul class="contentList mt-4">

                            <li>Wire Transfer</li>
                            <li>Foreign Currency Demand Draft</li>



                        </ul>
                        <h2 class="text-black  text-base font-semibold font-['Plus Jakarta Sans'] leading-normal mt-12">
                            What is wire transfer?</h2>
                        <p class="text-black/60 mt-12 text-sm font-normal font-['Plus Jakarta Sans'] leading-[21px]">
                            Wire Transfer (TT Transfer/SWIFT Transfer) is an electronic mode of fund transfer (through
                            SWIFT), with which you can transfer money from your Indian Bank account to an overseas bank
                            account. <br>

                            Indian Banks and RBI approved Authorized Dealers has arrangements with over 400+ major banks
                            across the globe to receive SWIFT messages which ensures safe and secure outward remittance
                            from India.</p>

                        <p class="text-black/60 mt-4 text-sm font-normal font-['Plus Jakarta Sans'] leading-[21px]">
                            Extravelmoney.com facilitates Wire transfer from India in 16+ currencies, including USD,
                            EUR, GBP, AUD, CAD, SGD..and others, through worldwide Correspondent Bank network.</p>

                        <h2 class="text-black  text-base font-semibold font-['Plus Jakarta Sans'] leading-normal mt-12">
                            Who can do a Wire Transfer from India?</h2>

                        <p class="text-black/60 mt-4 text-sm font-normal font-['Plus Jakarta Sans'] leading-[21px]">
                            Account holders of any Bank in India (resident and non-resident) can do a wire transfer from
                            India.</p>

                        <h2 class="text-black  text-base font-semibold font-['Plus Jakarta Sans'] leading-normal mt-12">
                            What is a foreign currency Demand Draft?</h2>

                        <p class="text-black/60 mt-4 text-sm font-normal font-['Plus Jakarta Sans'] leading-[21px]">A
                            Foreign Currency Demand Draft is another facility for making international money transfer
                            for educational payments, medical fees, VISA fees or migrating to other countries etc.
                            Demand drafts are a safe option for making international money transfer as it is made
                            'favouring' the beneficiary. DDs can be reissued if lost or stolen.</p>

                        <h2 class="text-black  text-base font-semibold font-['Plus Jakarta Sans'] leading-normal mt-12">
                            Main Purposes of International Money Transfer from India.
                        </h2>
                        ...
                        <ul class="contentList mt-4">
                            ...
                            <li>Emigration Fees</li>
                            <li>Visa Fees</li>
                            <li>Film Making</li>
                            <li>Maintenance of Close Relatives</li>
                            <li>Medical treatment abroad..etc</li>
                        ...
                        <h2 class="text-black  text-base font-semibold font-['Plus Jakarta Sans'] leading-normal mt-12">
                            Remitter needs to share the following information of Beneficiary:
                        </h2>

                        <ul class="contentList mt-4">

                            <li>Beneficiary Bank Name, Swift Code & Correspondent Account No.</li>
                            <li>Beneficiary Name, Address (as given in bank)</li>
                            <li>Remitter Name, Account Number and Purpose of Transaction with KYC.</li>
                            <li>Filled A2 Form cum declaration with signature</li>
                        ...
                        <h2 class="text-black  text-base font-semibold font-['Plus Jakarta Sans'] leading-normal mt-12">
                            Benefits of making a Wire Transfer via www.extravelmoney.com
                        </h2>

                        <ul class="contentList mt-4">

                            <li>Most secured and trusted channel for international money transfer from India</li>
                            <li>Competitive exchange rates</li>
                            <li>Compare the rates quoted by different Authorized Dealers near to your Town/City</li>
                            <li>Zero Commission</li>
                            <li>Direct Credit to your beneficiary account in less than 48 hours</li>
                            <li>Transfer facility in multiple currencies</li>
                            <li>Network of 4000+ locations across India</li>
                        ...
                        <ul class="contentList mt-4">
                            ...
                            <li>All foreign currency transactions are subject to GST.</li>
                            <li>Foreign Exchange and Money Transfer services are available though Tied-up Reserve Bank
                                of India approved Authorized Dealers only. All foreign exchange transactions are
                                subjected to AML/CFT/KYC & FEMA policies instructed by Reserve Bank of India.</li>
                        ...
                        <div class="tableSection mt-6 w-full customMd:w-1/2">
                            <div class="tableContainer">

                                <div class="tableBody">
                                    <div class="tableRow" data-url="https://www.extravelmoney.com/buy-forex/us-dollar/">
                                        <div class="currencyDetails columnSpec">
                                            ...
                                            <div class="curremcyNameContainer">
                                                ...
                                                <span class="currencyFull">US Dollars</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="tableRow"
                                        data-url="https://www.extravelmoney.com/buy-forex/british-pound/">
                                        <div class="currencyDetails columnSpec">
                                            <span class="flag-icon icon-dropdown-flag flag-icon-gb"></span>
                                            <div class="curremcyNameContainer">
                                                <p class="currencyShort">GBP</p>
                                                <span class="currencyFull">British Sterling Pound</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="tableRow" data-url="https://www.extravelmoney.com/buy-forex/euro/">
                                        <div class="currencyDetails columnSpec">
                                    ...
                                    <div class="tableRow"
                                        data-url="https://www.extravelmoney.com/buy-forex/singapore-dollar/">
                                        <div class="currencyDetails columnSpec">
                                            <span class="flag-icon icon-dropdown-flag flag-icon-sg"></span>
                                            <div class="curremcyNameContainer">
                                                <p class="currencyShort">SGD</p>
                                                <span class="currencyFull">Singapore Dollars</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="tableRow"
                                        data-url="https://www.extravelmoney.com/buy-forex/canadian-dollar/">
                                        <div class="currencyDetails columnSpec">
                                            <span class="flag-icon icon-dropdown-flag flag-icon-ca"></span>
                                            <div class="curremcyNameContainer">
                                                <p class="currencyShort">CAD</p>
                                                <span class="currencyFull">Canadian Dollars</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="tableRow"
                                        data-url="https://www.extravelmoney.com/buy-forex/australian-dollar/">
                                        <div class="currencyDetails columnSpec">
                                            <span class="flag-icon icon-dropdown-flag flag-icon-au"></span>
                                            <div class="curremcyNameContainer">
                                                <p class="currencyShort">AUD</p>
                                                <span class="currencyFull">Australian Dollars</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="tableRow"
                                        data-url="https://www.extravelmoney.com/buy-forex/swiss-franc/">
                                        <div class="currencyDetails columnSpec">
                                            <span class="flag-icon icon-dropdown-flag flag-icon-ch"></span>
                                            <div class="curremcyNameContainer">
                                                <p class="currencyShort">CHF</p>
                                                <span class="currencyFull">Swiss Franc</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="tableRow"
                                        data-url="https://www.extravelmoney.com/buy-forex/hong-kong-dollar/">
                                        <div class="currencyDetails columnSpec">
                                            <span class="flag-icon icon-dropdown-flag flag-icon-hk"></span>
                                            <div class="curremcyNameContainer">
                                                <p class="currencyShort">HKD</p>
                                                <span class="currencyFull">Hong Kong Dollars</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="tableRow"
                                        data-url="https://www.extravelmoney.com/buy-forex/japanese-yen/">
                                        <div class="currencyDetails columnSpec">
                                            <span class="flag-icon icon-dropdown-flag flag-icon-jp"></span>
                                            <div class="curremcyNameContainer">
                                                <p class="currencyShort">JPY</p>
                                                <span class="currencyFull">Japanese Yen</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="tableRow"
                                        data-url="https://www.extravelmoney.com/buy-forex/uae-dirham/">
                                        <div class="currencyDetails columnSpec">
                                            <span class="flag-icon icon-dropdown-flag flag-icon-ae"></span>
                                            <div class="curremcyNameContainer">
                                                <p class="currencyShort">AED</p>
                                                <span class="currencyFull">Arab Emirates Dirham</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="tableRow"
                                        data-url="https://www.extravelmoney.com/buy-forex/saudi-riyal/">
                                        <div class="currencyDetails columnSpec">
                                            <span class="flag-icon icon-dropdown-flag flag-icon-sa"></span>
                                            <div class="curremcyNameContainer">
                                                <p class="currencyShort">SAR</p>
                                                <span class="currencyFull">Saudi Arabian Riyal</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="tableRow"
                                        data-url="https://www.extravelmoney.com/buy-forex/danish-krone/">
                                        <div class="currencyDetails columnSpec">
                                            <span class="flag-icon icon-dropdown-flag flag-icon-dk"></span>
                                            <div class="curremcyNameContainer">
                                                <p class="currencyShort">DKK</p>
                                                <span class="currencyFull">Danish Kroner</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="tableRow"
                                        data-url="https://www.extravelmoney.com/buy-forex/norwegian-krone/">
                                        <div class="currencyDetails columnSpec">
                                            <span class="flag-icon icon-dropdown-flag flag-icon-no"></span>
                                            <div class="curremcyNameContainer">
                                                <p class="currencyShort">NOK</p>
                                                <span class="currencyFull">Norwegian Kroner</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="tableRow"
                                        data-url="https://www.extravelmoney.com/buy-forex/swedish-krona/">
                                        <div class="currencyDetails columnSpec">
                                            <span class="flag-icon icon-dropdown-flag flag-icon-se"></span>
                                            <div class="curremcyNameContainer">
                                                <p class="currencyShort">SEK</p>
                                                <span class="currencyFull">Swedish Kroner</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="tableRow"
                                        data-url="https://www.extravelmoney.com/buy-forex/qatari-riyal/">
                                        <div class="currencyDetails columnSpec">
                                            <span class="flag-icon icon-dropdown-flag flag-icon-qa"></span>
                                            <div class="curremcyNameContainer">
                                                <p class="currencyShort">QAR</p>
                                                <span class="currencyFull">Qatari Riyal</span>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="tableRow"
                                        data-url="https://www.extravelmoney.com/buy-forex/new-zealand-dollar/">
                                        <div class="currencyDetails columnSpec">
                                            <span class="flag-icon icon-dropdown-flag flag-icon-nz"></span>
                                            <div class="curremcyNameContainer">
                                                <p class="currencyShort">NZD</p>
                                                <span class="currencyFull">New Zealand Dollar</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
