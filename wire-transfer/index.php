...
<?php
$title="Send Money Abroad from India the Easy Way - ExTravelMoney"; 
...
<body>
        ...
        <div class="w-full chooseCityOverlayMain  relative" style="max-width: 103rem;">
            ...
            <section class="mainSection  w-full flex justify-center items-center  relative">
                <div
                    ...
                    <div class="w-full md:w-6/12 md:pr-4 widgetContainer">
                        ...
                        <!--    savings-->
                        <!--</h1>-->
                        <h1 class="text-[1.9rem] md:text-headingCustom text-black font-bold tracking-tight">Send Money Abroad from India
                        </h1>
                        <p
                            class="text-opacity-60 sm:text-opacity-100 text-black mt-3 text-base sm:text-mediumFont sm:w-11/12">
                            Send money from India to abroad easily at lowest exchange rates via RBI approved banks & exchange houses. Fast processing, great savings, zero hassle!</p>
            ...
            <div class="cityPageContainer">
                <div class="flex items-center gap-2">
                        ...
                        <h2 class="text-[#040815] text-xl customMd:text-[40px] font-bold  customMd:leading-[60px] ">Transfer Money to 100+ Countries</h2>
                    </div>
        ...
        <div class="location">
            ...
            <svg class="locationBtnArrow" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">                             <path d="M17.031 12.5307L9.53104 20.0307C9.46136 20.1004 9.37863 20.1556 9.28759 20.1933C9.19654 20.2311 9.09896 20.2505 9.00042 20.2505C8.90187 20.2505 8.80429 20.2311 8.71324 20.1933C8.6222 20.1556 8.53947 20.1004 8.46979 20.0307C8.40011 19.961 8.34483 19.8783 8.30712 19.7872C8.26941 19.6962 8.25 19.5986 8.25 19.5001C8.25 19.4015 8.26941 19.3039 8.30712 19.2129C8.34483 19.1218 8.40011 19.0391 8.46979 18.9694L15.4401 12.0001L8.46979 5.03068C8.32906 4.88995 8.25 4.69907 8.25 4.50005C8.25 4.30103 8.32906 4.11016 8.46979 3.96943C8.61052 3.8287 8.80139 3.74963 9.00042 3.74963C9.19944 3.74963 9.39031 3.8287 9.53104 3.96943L17.031 11.4694C17.1008 11.5391 17.1561 11.6218 17.1938 11.7128C17.2316 11.8039 17.251 11.9015 17.251 12.0001C17.251 12.0986 17.2316 12.1962 17.1938 12.2873C17.1561 12.3783 17.1008 12.461 17.031 12.5307Z" fill="white"/>                         </svg>
                ...
                <div>
                    <div class="flex items-center gap-2">
                        <div class="w-2 h-12 bg-[#e31d1c]"></div>
                        <h2 class="text-[#040815] text-xl customMd:text-[40px] font-bold  customMd:leading-[60px] ">How to Transfer Money from India to Abroad?</h2>
                    </div>
                    <p class="text-black/60 mt-2 text-sm font-normal  leading-[21px]">To send money from India to abroad, follow the four steps.</p>
                    ...
                    <ul class="contentList mt-4">
                        ...
                        <li>Enter the country, amount, purpose of remittance and get rates from nearest banks & exchange houses</li>
                        <li>Compare the rates, choose any and book your money transfer online. Submit your KYC documents for verification.</li>
                        <li>Once the KYC is verified you can transfer the amount as NEFT/RTGS to chosen bank/exchange house's account.</li>
                        <li>Your wire transfer will now be initiated. The beneficiary will recive the credit with in 2-3 working days.</li>
                        
                    
                    </ul>
                    
                    <h2 class="text-black  text-base font-semibold font-['Plus Jakarta Sans'] leading-normal mt-12">Modes for Outward Remittance from India</h2>
                    ...
                    <h2 class="text-black  text-base font-semibold font-['Plus Jakarta Sans'] leading-normal mt-12">What is wire transfer?</h2>
                    <p class="text-black/60 mt-12 text-sm font-normal font-['Plus Jakarta Sans'] leading-[21px]">Wire Transfer (TT Transfer/SWIFT Transfer) is an electronic mode of fund transfer (through SWIFT), with which you can transfer money from your Indian Bank account to an overseas bank account. <br>
                    
                      Indian Banks and RBI approved Authorized Dealers has arrangements with over 400+ major banks across the globe to receive SWIFT messages which ensures safe and secure outward remittance from India.</p>
                    
                    <p class="text-black/60 mt-4 text-sm font-normal font-['Plus Jakarta Sans'] leading-[21px]">Extravelmoney.com facilitates Wire transfer from India in 16+ currencies, including USD, EUR, GBP, AUD, CAD, SGD..and others, through worldwide Correspondent Bank network.</p>
                    
                    <h2 class="text-black  text-base font-semibold font-['Plus Jakarta Sans'] leading-normal mt-12">Who can do a Wire Transfer from India?</h2>
                    
                    <p class="text-black/60 mt-4 text-sm font-normal font-['Plus Jakarta Sans'] leading-[21px]">Account holders of any Bank in India (resident and non-resident) can do a wire transfer from India.</p>
                    
                    <h2 class="text-black  text-base font-semibold font-['Plus Jakarta Sans'] leading-normal mt-12">What is a foreign currency Demand Draft?</h2>
                    
                    <p class="text-black/60 mt-4 text-sm font-normal font-['Plus Jakarta Sans'] leading-[21px]">A Foreign Currency Demand Draft is another facility for making international money transfer for educational payments, medical fees, VISA fees or migrating to other countries etc. Demand drafts are a safe option for making international money transfer as it is made 'favouring' the beneficiary. DDs can be reissued if lost or stolen.</p>
                    
                    <h2 class="text-black  text-base font-semibold font-['Plus Jakarta Sans'] leading-normal mt-12">Main Purposes of International Money Transfer from India.
                    </h2>
                    ...
                    <h2 class="text-black  text-base font-semibold font-['Plus Jakarta Sans'] leading-normal mt-12">Remitter needs to share the following information of Beneficiary:
                    </h2>
                    ...
                    <h2 class="text-black  text-base font-semibold font-['Plus Jakarta Sans'] leading-normal mt-12">Benefits of making a Wire Transfer via www.extravelmoney.com
                    </h2>
                    ...
                    <p class="text-black/60 mt-4 text-sm font-normal font-['Plus Jakarta Sans'] leading-[21px]">Notes:</p>
                    
                    <ul class="contentList mt-4">
                        
                        <li>All foreign currency transactions are subject to GST.</li>
                        <li>Foreign Exchange and Money Transfer services are available though Tied-up Reserve Bank of India approved Authorized Dealers only. All foreign exchange transactions are subjected to AML/CFT/KYC & FEMA policies instructed by Reserve Bank of India.</li>
                    ...
                    <h2 class="text-black  text-base font-semibold font-['Plus Jakarta Sans'] leading-normal mt-12">Currencies available for making a direct Outward Remittance
                    </h2>
    ...
    <div class="tableRow" data-url="https://www.extravelmoney.com/buy-forex/british-pound/">
        <div class="currencyDetails columnSpec">
    ...
    <div class="tableRow" data-url="https://www.extravelmoney.com/buy-forex/singapore-dollar/">
        <div class="currencyDetails columnSpec">
    ...
    <div class="tableRow" data-url="https://www.extravelmoney.com/buy-forex/canadian-dollar/">
        <div class="currencyDetails columnSpec">
    ...
    <div class="tableRow" data-url="https://www.extravelmoney.com/buy-forex/australian-dollar/">
        <div class="currencyDetails columnSpec">
    ...
    <div class="tableRow" data-url="https://www.extravelmoney.com/buy-forex/swiss-franc/">
        <div class="currencyDetails columnSpec">
    ...
    <div class="tableRow" data-url="https://www.extravelmoney.com/buy-forex/hong-kong-dollar/">
        <div class="currencyDetails columnSpec">
    ...
    <div class="tableRow" data-url="https://www.extravelmoney.com/buy-forex/japanese-yen/">
        <div class="currencyDetails columnSpec">
    ...
    <div class="tableRow" data-url="https://www.extravelmoney.com/buy-forex/uae-dirham/">
        <div class="currencyDetails columnSpec">
    ...
    <div class="tableRow" data-url="https://www.extravelmoney.com/buy-forex/saudi-riyal/">
        <div class="currencyDetails columnSpec">
    ...
    <div class="tableRow" data-url="https://www.extravelmoney.com/buy-forex/danish-krone/">
        <div class="currencyDetails columnSpec">
    ...
    <div class="tableRow" data-url="https://www.extravelmoney.com/buy-forex/norwegian-krone/">
        <div class="currencyDetails columnSpec">
    ...
    <div class="tableRow" data-url="https://www.extravelmoney.com/buy-forex/swedish-krona/">
        <div class="currencyDetails columnSpec">
    ...
    <div class="tableRow" data-url="https://www.extravelmoney.com/buy-forex/qatari-riyal/">
        <div class="currencyDetails columnSpec">
    ...
    <div class="tableRow" data-url="https://www.extravelmoney.com/buy-forex/new-zealand-dollar/">
        <div class="currencyDetails columnSpec">
