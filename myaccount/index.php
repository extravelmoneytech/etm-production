                    ...
                    <div class="grid grid-cols-4 md:grid-cols-7 overflow-hidden place-content-center rounded-2xl border border-black/10 w-full"  style="background: linear-gradient(329deg, rgba(14, 81, 160, 0.10) -43.1%, rgba(227, 29, 28, 0.10) 144.49%); ">
                        ...
                        <div class="col-span-4 md:col-span-2 py-3 pr-3 pl-3 md:pl-0 justify-between items-center gap-2 flex md:flex-col">
                            <div class="flex gap-2">
                                <div class="w-8 h-8 bg-[#20bc73] rounded-md shadow justify-center items-center gap-[6.67px] inline-flex" id="whatsappAffiliate">
                                ...
                                <div class="w-8 h-8 bg-[#0e51a0] rounded-md shadow justify-center items-center gap-[6.67px] inline-flex" id="emailAffiliate">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                            ...
                            <div class="w-full flex justify-center items-center">
                                <div class="h-8 bg-white rounded-lg justify-center items-center gap-1 inline-flex w-full md:w-4/5 px-2 cursor-pointer" id="referralCopy">
                                    <span class="text-[#18325b] text-[13px] font-medium  leading-tight ">Copy</span>
