...
$title = "Buy Forex Online in India | Compare Rates | Get Door Delivery";
$description = "Buying forex in India is now easy! Compare rates from 4500+ RBI authorized money changers. Book online & get door delivery of foreign currency & forex travel cards. Also lock rates for up to two days!";
$sub = 1;
$page = 3000;
$citypage = 1;
$curpage = 0;
...
$ogurl = "https://www.extravelmoney.com/buy-forex/";
$ogtype = "article";
$buy_forex = true;
            ...
            <section class="mainSection  w-full flex justify-center items-center  relative">
                <div
                    ...
                    <div class="w-full md:w-6/12 md:pr-4 widgetContainer">
                        ...
                        <!--    savings-->
                        <!--</h1>-->
                        <h1 class="text-[1.9rem] md:text-headingCustom text-black font-bold tracking-tight">Buy Forex
                            Online In India From Nearest Money Changers
                        </h1>
                        <p
                            class="text-opacity-60 sm:text-opacity-100 text-black mt-3 text-base sm:text-mediumFont sm:w-11/12">
                            COMPARE RATES, BOOK ONLINE & GET DOOR DELIVERY!
                        </p>
