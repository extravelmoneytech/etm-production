...
<html lang="en">
<?php
$title = "Qatari Riyal Rate in India Today | QAR Buying Rate | QAR Selling Rate";
$description = "Find Qatari Riyal rate in India today and QAR-INR rate history. Get today's buy and sell rates of Qatari Riyal in India. Exchange QAR currency, buy forex card or send money to Qatar easily!";
$sub = 1;
$page = 0;
$city = 0;
$curpage = 1;
$fold = "../../";
$ogurl = "https://www.extravelmoney.com/rates/qar/";
$ogtype = "article";

$country = "Qatar";
$currency = "QAR";
$currencyfull = "Qatari Riyal";
$ratesPage = true;
