...
<html lang="en">
<?php
$title = "Japanese Yen Rate in India Today | JPY to INR Buying & Selling Rates";
$description = "Find Japanese Yen rate in India today and JPY to INR rate history. Also find today's best buy & sell rates of Japanese Yen in India, across major cities. Exchange JPY currency, buy forex card or send money to Japan easily!";
$sub = 1;
$page = 0;
$city = 0;
$curpage = 1;
$fold = "../../";
$ogurl = "https://www.extravelmoney.com/rates/jpy/";
$ogtype = "article";


$country = "Japan";
$currency = "JPY";
$currencyfull = "Japanese Yen";
$ratesPage = true;
