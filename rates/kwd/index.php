...
<html lang="en">
<?php
$title = "Kuwaiti Dinar Rate in India | KWD Buying Rate Today | KWD Selling Rate";
$description = "Find Kuwaiti Dinar rate in India today and KWD-INR rate history. Get today's buy & sell rates of Kuwaiti Dinar in India. Exchange KWD currency, buy forex card or transfer money abroad easily!";
$sub = 1;
$page = 0;
$city = 0;
$curpage = 1;
$fold = "../../";
$ogurl = "https://www.extravelmoney.com/rates/kwd/";
$ogtype = "article";
