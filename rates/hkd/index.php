...
<html lang="en">
<?php
$title = "Hong Kong Dollar Rate in India |HKD Buying Rate |HKD to INR Selling Rate";
$description = "Find Hong Kong Dollar rate in India today and HKD to INR rate history. Also find today's best rates for buying & selling Hong Kong Dollar in India, across major cities. Buy or sell Hong Kong Dollar currency & forex card easily!";
$sub = 1;
$page = 0;
$city = 0;
$curpage = 1;
$fold = "../../";
$ogurl = "https://www.extravelmoney.com/rates/hkd/";
$ogtype = "article";
