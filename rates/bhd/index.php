...
<html lang="en">
<?php
$title = "Bahraini Dinar Buying Rate in India Today | Bahraini Dinar Selling Rate";
$description = "Find Bahraini Dinar rate in India today and BHD-INR rate history. Get today's buy & sell rates of Bahraini Dinar in India. Exchange BHD currency, buy forex card or transfer money abroad easily!";
$sub = 1;
$page = 0;
$city = 0;
$curpage = 1;
$fold = "../../";
$ogurl = "https://www.extravelmoney.com/rates/bhd/";
$ogtype = "article";
