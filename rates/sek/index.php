...
<html lang="en">
<?php
$title = "Swedish Krona Rate in India Today | SEK Buying Rate | SEK Selling Rate";
$description = "Find Swedish Krona rate in India today and SEK-INR rate history. Get today's buy & sell rates of Swedish Krona in India. Exchange SEK currency, buy forex card or transfer money abroad easily!";
$sub = 1;
$page = 0;
$city = 0;
$curpage = 1;
$fold = "../../";
$ogurl = "https://www.extravelmoney.com/rates/sek/";
$ogtype = "article";
