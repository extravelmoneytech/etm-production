...
<html lang="en">
<?php
$title = "Malaysian Ringgit Rate in India | MYR Buying Rate | MYR to INR Selling Rate";
$description = "Find Malaysian Ringgit rate in India today and MYR to INR rate history. Also find today's best rates for buying & selling Malaysian Ringgit in cities across India. Exchange MYR currency, buy forex card or send money to Malaysia easily!";
$sub = 1;
$page = 0;
$city = 0;
$curpage = 1;
$fold = "../../";
$ogurl = "https://www.extravelmoney.com/rates/myr/";
$ogtype = "article";
