...
<html lang="en">
<?php
$title = "Danish Krone Rate in India Today | DKK Buying Rate | DKK Selling Rate";
$description = "Find Danish Krone rate in India today and DKK-INR rate history. Get today's buy & sell rates of Danish Krone in India. Exchange DKK currency, buy forex card or transfer money abroad easily!";
$sub = 1;
$page = 0;
$city = 0;
$curpage = 1;
$fold = "../../";
$ogurl = "https://www.extravelmoney.com/rates/dkk/";
$ogtype = "article";
