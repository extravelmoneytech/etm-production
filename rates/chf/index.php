...
<html lang="en">
<?php
$title = "Swiss Franc Rate in India | CHF Buying Rate | CHF to INR Selling Rate";
$description = "Find Swiss Franc rate in India today and CHF-INR rate history. Get today's buy & sell rates of Swiss Franc in India. Exchange CHF currency, buy forex card or transfer money to Switzerland easily!";
$sub = 1;
$page = 0;
$city = 0;
$curpage = 1;
$fold = "../../";
$ogurl = "https://www.extravelmoney.com/rates/chf/";
$ogtype = "article";
