...
<html lang="en">
<?php
$title = "Chinese Yuan Renminbi (RMB) Rate in India | RMB Buying & Selling Rates";
$description = "Find today's Chinese Yuan(CNY) Rate in India & CNY to INR rate history. Get today's best rates for buying and selling Chinese Yuan in India across major cities. Exchange Renminbi (RMB) currency, buy forex card or send money to China easily!";
$sub = 1;
$page = 0;
$city = 0;
$curpage = 1;
$fold = "../../";
$ogurl = "https://www.extravelmoney.com/rates/cny/";
$ogtype = "article";


$country = "China";
$currency = "CNY";
$currencyfull = "Chinese Yuan Renminbi";
$ratesPage = true;
