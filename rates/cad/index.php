...
<?php
$title = "Canadian Dollar Buying Rate In India Today | CAD to INR Selling Rate";
$description = "Find Canadian Dollar rate today in India and CAD-INR rate history. Also find today's best Canadian Dollar buying rate & selling rate in India, across major cities. Exchange CAD currency, buy forex card or send money to Canada easily!";
$sub = 1;
$page = 0;
$city = 0;
$curpage = 1;
$fold = "../../";
$ogurl = "https://www.extravelmoney.com/rates/cad/";
$ogtype = "article";
