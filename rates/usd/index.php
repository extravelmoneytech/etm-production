...
<html lang="en">
<?php
$title = "USD Rate in India Today | US Dollar Buying Rate |USD to INR Selling Rate";
$description = "Find today's US Dollar rate in India. Also find the best USD buying rate & USD selling rate in India, across major cities. Compare rates, book online & get US Dollar currency and Forex card door delivered or picked up by RBI authorized money changers in your city!";
$sub = 1;
$page = 0;
$city = 0;
$curpage = 1;
$fold = "../../";
$ogurl = "https://www.extravelmoney.com/rates/usd/";
$ogtype = "article";
