...
<html lang="en">
<?php
$title = "South African Rand Rate in India | ZAR Buying Rate | ZAR Selling Rate";
$description = "Find South African Rand rate in India today and ZAR-INR rate history. Get today's buy & sell rates of South African Rand in India. Exchange ZAR currency, buy forex card or transfer money abroad easily!";
$sub = 1;
$page = 0;
$city = 0;
$curpage = 1;
$fold = "../../";
$ogurl = "https://www.extravelmoney.com/rates/zar/";
$ogtype = "article";


$country = "South Africa";
$currency = "ZAR";
$currencyfull = "South African Rand";
$ratesPage = true;
