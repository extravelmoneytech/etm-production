...
<html lang="en">
<?php
$title = "Omani Rial Rate in India Today | OMR Buying Rate | OMR Selling Rate";
$description = "Find Omani Rial rate in India today and OMR-INR rate history. Get today's buy & sell rates of Omani Rial in India. Exchange OMR currency, buy forex card or transfer money abroad easily!";
$sub = 1;
$page = 0;
$city = 0;
$curpage = 1;
$fold = "../../";
$ogurl = "https://www.extravelmoney.com/rates/omr/";
$ogtype = "article";

$country = "Oman";
$currency = "OMR";
$currencyfull = "Omani Rial";
$ratesPage = true;
