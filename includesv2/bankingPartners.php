<section class="flex flex-col mt-24 customMd:mt-40 xl:mt-60 " >
                ...
                <div class="px-5 sm:px-12 md:px-24 py-12" style="background: rgba(24, 50, 91, 0.04);">
                    <p class="text-black text-center text-lg font-semibold">6000 + RBI Authorized Exchange Houses on the Platform.
                    </p>
                    <div class="flex gap-8 justify-center items-center customMd:items-end mt-6 flex-col customMd:flex-row">
                        <span class="text-black/60 text-base font-semibold leading-normal mb-2">Powered by leading banks </span>
                    
                        <img src="<?php echo $fold . 'public/images/logo/icici1.svg'; ?>" class="w-40" alt="icici-logo">
                        <img src="<?php echo $fold . 'public/images/logo/rbl.svg'; ?>" class="w-36" alt="rbl-logo">
