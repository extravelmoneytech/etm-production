<section class="mainSection  w-full flex justify-center items-center  relative">
    <div
        ...
        <div class="w-full md:w-6/12 md:pr-4 widgetContainer">
            ...
            <h1 class="text-[1.9rem] md:text-headingCustom text-black font-bold tracking-tight">
                <p style="background: linear-gradient(26deg, #0E51A0 1.1%, #E3373A 40.49%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;"
                    class="text-xl md:text-4xl text-black font-bold tracking-tight">Best Rates for
                    <?php echo $currencyfull; ?> in India Today
                </p>
            </h1>
            ...
            <div class="relative border w-full sm:w-4/5 mt-6 rounded-lg overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="w-full text-xs sm:text-sm text-left rtl:text-right font-['Plus Jakarta Sans']">
                        <thead style="background: linear-gradient(26deg, #0E51A0 -20.1%, #E3373A 90.49%);">
                            <tr>
                                <th scope="col" class="px-3 sm:px-6 py-3 text-white font-semibold">
                                    <div class="flex  items-center xs:gap-12 sm:gap-4 lg:gap-6 gap-6">
                                        <span>Currency</span>
                                        <div
                ...
                <div class="flex gap-8">
                    <div class="flex flex-col gap-2">
                        ...
                        <p class="text-xl w-full font-bold"
                            ...
                            Save More</p>
                        <span class="text-black/60 text-sm font-normal  leading-normal">5%+ better than <br />market
                            rates.</span>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                            ...
                            <path
                                ...
                                stroke="black" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                                stroke-linejoin="round" />
                            <path d="M6.75 17.5166V18.2816C6.75 21.4398 9.31022 24 12.4684 24H21.0459" stroke="black"
                        ...
                        <p class="text-xl w-full font-bold"
                            style="word-wrap: break-word;background: linear-gradient(329deg, #0E51A0 -43.1%, #E31D1C 144.49%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
                            Fast Credit</p>
                        <span class="text-black/60 text-sm font-normal  leading-normal">Credit/Delivery in <br />48
                            working hours.</span>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                            <g clip-path="url(#clip0_1947_23067)">
                                ...
                                <path
                                    ...
                                    stroke="#0E51A0" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path d="M1.03125 34.39L8.48051 26.9428L21.0528 39.5186L13.6035 46.9658L1.03125 34.39Z"
                                    stroke="black" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path
                        ...
                        <p class="text-xl w-full font-bold"
                            style="word-wrap: break-word;background: linear-gradient(329deg, #0E51A0 -43.1%, #E31D1C 144.49%);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
                            Expert Help</p>
                        <span class="text-black/60 text-sm font-normal  leading-normal">Professional support,<br />every
                            step</span>
        ...
        <div
            class="w-full max-w-xl md:items-center md:w-6/12 flex items-end sm:justify-start mt-8 customMd:mt-0 flex-col">
