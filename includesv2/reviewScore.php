<div class="flex justify-start sm:w-11/12 mt-6 sm:mt-10 pr-5 select-none">
     ...
     src="<?php echo $fold . 'public/images/logo/trustpilot-logo.svg?ver=1.1'; ?>" alt="trustpilot-logo">
                            ...
                            <img class="w-20 sm:w-24 self-auto" src="<?php echo $fold . 'public/images/logo/Google_2015_logo.svg'; ?>" alt="google-logo">
                                ...
                                <a  target="_blank" href="https://www.google.com/search?q=extravelmoney+google+reviews&amp;sca_esv=581829575&amp;ei=ZrNRZcL_BqaR4-EP0s2N8Aw&amp;oq=extravelmoney+google&amp;gs_lp=Egxnd3Mtd2l6LXNlcnAiFGV4dHJhdmVsbW9uZXkgZ29vZ2xlKgIIADIFECEYoAEyBRAhGKABSLIvUOIEWJwocAR4AZABAJgB-&amp;sclient=gws-wiz-serp#lrd=0x3b080d41733b63cb:0xeada03210a09e134,1,,,,"><span
                                    class="underline hidden sm:block text-gray-400 text-xs font-normal cursor-pointer">See
                                    reviews</span></a>
                            </div>
