                    ...
                    foreach ($cities as $cityName => $cityUrl) {
                        if ($cityName == $city  ) { ?>
                            ...
                            <div class="flex justify-start">
                                <a href="<?php echo $fold; ?>rates/usd/<?php echo $cityUrl ?>">
    ...
    <div class="flex flex-col mt-16">
        <div>
            <div class="flex items-center gap-2">
                ...
                if ($ratesPage == true) {
                    echo '<h2 class="text-[#040815] text-xl customMd:text-[40px] font-bold customMd:leading-[60px]">
                        Find the Best ' . $currencyFullName . ' Rate in India Today
                    </h2>';
                }
                ?>
            </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 mt-8">
                    ...
                    foreach ($cities as $cityName => $citySlug) {
                        if ($cityName !== $city) {
                            ...
                            $label = strtoupper($currency) . " Rates in $cityName";
                            ?>
                            <div class="flex justify-start">
                                <a href="<?php echo $url; ?>">
                                    <div class="flex items-center location group space-x-1">
                                        <span class="locationName"><?php echo $label; ?></span>
                                        <svg class="locationBtnArrow opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out"
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                            fill="none">
                                            <path
