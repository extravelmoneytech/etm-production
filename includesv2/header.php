...
<header class="w-full flex justify-start items-center">
                <div class="hidden md:flex w-full">
                    <div class="navContainer justify-between  flex w-full px-24 py-8 pt-10 items-start gap-8">
                       <a href="/"><img src="<?php echo $fold . 'public/images/logo/ETM logo without tagline.png'; ?>" class="w-44 object-contain" alt="ETM logo">
                       </a> 
                        ...
                        <nav class="flex flex-wrap gap-12 items-center justify-end text-base tracking-tight leading-loose text-black customMd:gap-y-6">
                            ...
                            <a href="<?php echo $fold; ?>myaccount"  class="myAccount text-mediumFont custom-underline flex  justify-center items-center cursor-pointer">My Account</a>
