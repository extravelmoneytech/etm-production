        ...
        <div class="w-full chooseCityOverlayMain  relative" style="max-width: 103rem;">
            ...
            <div class="cityPageContainer mt-12">
                ...
                <div class="flex  items-center gap-2 ">
                    ...
                    <h2 class="text-[#040815] text-xl  customMd:text-[40px] font-bold  customMd:leading-[60px] ">Get 4Hr
                        Ultra-Fast Payments to Select Universities!</h2>


                </div>

                <p class="text-black/60 mt-8 text-sm font-normal font-['Plus Jakarta Sans'] leading-[21px]"> Make
                    Ultra-Fast fee payments to the following universities! You get payment confirmation from the
                    university within 4 hours!</p>
                ...
                <div class="mt-8 flex flex-col gap-16">
                    <div class="australia">
                        ...
                        <div class="flex flex-wrap mt-6 gap-x-20 gap-y-6 sm:gap-y-10">
                            ...
                            <p class="text-black text-base font-medium leading-normal">2. Griffith University</p>
                            <p class="text-black text-base font-medium leading-normal">3. Swinburne University</p>
                            <p class="text-black text-base font-medium leading-normal">4. Macquarie University</p>
                            <p class="text-black text-base font-medium leading-normal">5. RMIT University</p>
                            <p class="text-black text-base font-medium leading-normal">6. University of Canberra</p>
                            <p class="text-black text-base font-medium leading-normal">7. The University of Adelaide</p>
                            <p class="text-black text-base font-medium leading-normal">8. Western Sydney University</p>
                            <p class="text-black text-base font-medium leading-normal">9. Flinders University</p>
                        </div>
                    </div>
                    ...
                    <div class="cananda">
                        ...
                        <div class="flex flex-wrap mt-6 gap-x-20 gap-y-6 sm:gap-y-10">
                            ...
                            <p class="text-black text-base font-medium leading-normal">2. George Brown College</p>
                            <p class="text-black text-base font-medium leading-normal">3. University Canada West</p>
                            <p class="text-black text-base font-medium leading-normal">4. Seneca College</p>
                            <p class="text-black text-base font-medium leading-normal">5. Algoma University</p>
                            <p class="text-black text-base font-medium leading-normal">6. Cape Bretom University</p>
                            <p class="text-black text-base font-medium leading-normal">7. Concordia University</p>
                            <p class="text-black text-base font-medium leading-normal">8. Fleming College</p>
                            ...
                            <p class="text-black text-base font-medium leading-normal">16. York University</p>
                        </div>
                    </div>
