...
<html lang="en">
<?php
$title="Currency Exchange in Delhi | Find the Best Rates -ExTravelMoney"; 
$description="Find the best rates for money exchange in Delhi online. Compare instant quotes from money changers in Delhi, book online & get forex door delivered!"; 
$fold="../../"; 

$ogurl="https://www.extravelmoney.com/foreign-exchange/delhi";
$ogtype="article";
            ...
            <section class="mainSection  w-full flex justify-center items-center  relative">
                <div
                    ...
                    <div class="w-full md:w-6/12 md:pr-4 widgetContainer">
                        ...
                        <!--    savings-->
                        <!--</h1>-->
                        <h1 class="mainText">Currency Exchange in Delhi Made Easy
                        </h1>
                        <p
                            class="paraText">
                            Get the best currency exchange rates in Delhi! Book foreign currency & forex cards online with doorstep delivery from RBI-authorized money changers.</p>
